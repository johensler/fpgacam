...
#
# Script generated by Vivado on Thu Jul 11 11:11:35 +0200 2024
...
#
# Usage        : frame_buffer.sh
#                frame_buffer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                frame_buffer.sh [-reset_run]
#                frame_buffer.sh [-reset_log]
#                frame_buffer.sh [-help]
#
...
#                script (type 'frame_buffer.sh -help' for more information).
#
...
# script info
echo -e "frame_buffer.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./frame_buffer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.frame_buffer xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.frame_buffer -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log frame_buffer_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: frame_buffer.sh [-step]\n\
Usage: frame_buffer.sh [-lib_map_path]\n\
Usage: frame_buffer.sh [-reset_run]\n\
Usage: frame_buffer.sh [-reset_log]\n\
Usage: frame_buffer.sh [-keep_index]\n\
