...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../final_project_v1.gen/sources_1/ip/ila_cam/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_cam xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_cam -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_cam_sc.so .tmp_log xcelium_lib waves.shm c.obj)
