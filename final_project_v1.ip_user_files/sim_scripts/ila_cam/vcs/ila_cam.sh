...
#
# Script generated by Vivado on Tue Jul 16 16:28:51 +0200 2024
...
# script info
echo -e "ila_cam.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../final_project_v1.gen/sources_1/ip/ila_cam/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_cam xil_defaultlib.glbl -o ila_cam_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_cam_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ila_cam_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_cam_simv.daidir vcs_lib c.obj)
