...
elaborate()
{
  xelab --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_cam xil_defaultlib.ila_cam xil_defaultlib.glbl -log elaborate.log
}
